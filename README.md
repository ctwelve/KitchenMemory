...
Version 0.3.5 is the current public alpha. A signed and notarized Apple silicon macOS
...
The published 0.3.5 macOS alpha requires macOS 27 or later and an Apple silicon
Mac. This download does not include an Intel executable.

1. Download `KitchenMemory-0.3.5-macOS.zip` from the [0.3.5 release](https://github.com/ctwelve/KitchenMemory/releases/tag/release/0.3.5).
