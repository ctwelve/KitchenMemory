...
# Keep the native multiplatform target, shared schemes and plans, localization
# prebuild ordering, destinations, resources, entitlements, and test hosts synchronized.
